...
namespace WebService.com.softexpert.tecfy {
    using System;
    ...
    public partial class Documento : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public Documento() {
            this.Url = global::WebService.Properties.Settings.Default.WebService_com_softexpert_tecfy_Documento;
        ...
        /// <remarks/>
        public void cancelDocumentAsync(string iddocument, string iduser, string dscancel) {
            this.cancelDocumentAsync(iddocument, iduser, dscancel, null);
        }
        
        /// <remarks/>
        public void cancelDocumentAsync(string iddocument, string iduser, string dscancel, object userState) {
            ...
            this.InvokeAsync("cancelDocument", new object[] {
                        iddocument,
                        iduser,
                        dscancel}, this.cancelDocumentOperationCompleted, userState);
        }
        ...
        /// <remarks/>
        public void listAccessPermissionAsync(string iddocument, string iduser) {
            this.listAccessPermissionAsync(iddocument, iduser, null);
        }
        
        /// <remarks/>
        public void listAccessPermissionAsync(string iddocument, string iduser, object userState) {
            ...
            this.InvokeAsync("listAccessPermission", new object[] {
                        iddocument,
                        iduser}, this.listAccessPermissionOperationCompleted, userState);
        }
        ...
        [return: System.Xml.Serialization.XmlElementAttribute("return")]
        public string newDocument(string idcategory, string iddocument, string title, string dsresume, string dtdocument, string attributes, string iduser, [System.Xml.Serialization.XmlArrayItemAttribute("item", IsNullable=false)] participantsData[] participants, int fgmodel) {
        ...
        /// <remarks/>
        public void newDocumentAsync(string idcategory, string iddocument, string title, string dsresume, string dtdocument, string attributes, string iduser, participantsData[] participants, int fgmodel) {
            this.newDocumentAsync(idcategory, iddocument, title, dsresume, dtdocument, attributes, iduser, participants, fgmodel, null);
        }
        
        /// <remarks/>
        public void newDocumentAsync(string idcategory, string iddocument, string title, string dsresume, string dtdocument, string attributes, string iduser, participantsData[] participants, int fgmodel, object userState) {
            ...
            this.InvokeAsync("newDocument", new object[] {
                        ...
                        iduser,
                        participants,
                        fgmodel}, this.newDocumentOperationCompleted, userState);
        }
        ...
        [return: System.Xml.Serialization.XmlElementAttribute("return")]
        public string newRevision(string iddocument, string iduser, [System.Xml.Serialization.XmlArrayItemAttribute("item", IsNullable=false)] participantsData[] participants, documentData documentdata, [System.Xml.Serialization.XmlArrayItemAttribute("item", IsNullable=false)] eletronicFile[] file, int fgstatus, string dsjustify) {
        ...
        /// <remarks/>
        public void newRevisionAsync(string iddocument, string iduser, participantsData[] participants, documentData documentdata, eletronicFile[] file, int fgstatus, string dsjustify) {
            this.newRevisionAsync(iddocument, iduser, participants, documentdata, file, fgstatus, dsjustify, null);
        }
        
        /// <remarks/>
        public void newRevisionAsync(string iddocument, string iduser, participantsData[] participants, documentData documentdata, eletronicFile[] file, int fgstatus, string dsjustify, object userState) {
            ...
            this.InvokeAsync("newRevision", new object[] {
                        ...
                        file,
                        fgstatus,
                        dsjustify}, this.newRevisionOperationCompleted, userState);
        }
        ...
        [return: System.Xml.Serialization.XmlElementAttribute("return")]
        public documentDataReturn viewDocumentData(string iddocument, string idrevision, string iduser) {
        ...
        /// <remarks/>
        public void viewDocumentDataAsync(string iddocument, string idrevision, string iduser) {
            this.viewDocumentDataAsync(iddocument, idrevision, iduser, null);
        }
        
        /// <remarks/>
        public void viewDocumentDataAsync(string iddocument, string idrevision, string iduser, object userState) {
            ...
            this.InvokeAsync("viewDocumentData", new object[] {
                        iddocument,
                        idrevision,
                        iduser}, this.viewDocumentDataOperationCompleted, userState);
        }
